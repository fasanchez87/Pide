...
public class CompraAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{
    ...
    public CompraAdapter(Activity activity, ArrayList<Producto> listadoProductos)
    {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
        ...
        {
            return new CompraHolder(inflater.inflate(R.layout.compra_row_layout,parent,false));
        }
        else
        {
    ...
    public class CompraHolder extends RecyclerView.ViewHolder
    {
        ...
        {
            super(view);
            imagenProductoCompra=(ImageView) view.findViewById(R.id.imagenProductoCompra);
            nombreProductoCompra=(TextView) view.findViewById(R.id.nombreProductoCompra);
            cantidadProductoCompra=(TextView) view.findViewById(R.id.cantidadProductoCompra);
            valorUnitarioProductoCompra = (TextView) view.findViewById(R.id.valorUnitarioProductoCompra);
            valorTotalCompraUnitaria = (TextView) view.findViewById(R.id.valorTotalCompraUnitaria);
        }
